                ...
                <div class="row card-body mb-2">
                    ...
                    <div class="mt-4 col-12 row">
                        <div class="col-md-3 col-6 mb-2">
                            <input class="form-check-input" type="checkbox" id="allowinsecure" name="allow_insecure">
                            <label class="form-check-label" for="allowinsecure">Allowlnsecure</label>
                        </div>
                        <div class="col-md-3 col-6 mb-2">
                            <input class="form-check-input" type="checkbox" id="enablemux" name="enable_mux">
                            <label class="form-check-label" for="enablemux">EnableMux</label>
                        </div>
                        <div class="col-md-3 col-6 mb-2">
                            <input class="form-check-input" type="checkbox" id="EnableFragment" name="enable_fragment">
                            <label class="form-check-label" for="EnableFragment">EnableFragment</label>
                        </div>
                        <div class="col-md-3 col-6 mb-2">
                            <input class="form-check-input" type="checkbox" id="PreferIpv6" name="prefer_ipv6">
